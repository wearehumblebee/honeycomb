...
import { useGlobalArgs, useAddonState, useStorybookApi } from '@storybook/api';
...
const ThemeSelectorTool = () => {
  ...
  // Unclear how to set a default value for globalArgs at the moment
  useEffect(() => {
    if (!globalArgs.theme) {
      updateTheme(theme);
    }
  }, [globalArgs.theme, theme.name]);
