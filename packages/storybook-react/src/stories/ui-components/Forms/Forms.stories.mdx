          ...
          <form onSubmit={sendDataToZion}>
            ...
            <Box sx={{ my: 3 }}>
              ...
              <Slider
                ...
                onChange={(event) => onInputChange('confidenceAboutJumpingBetweenBuildings', event.currentTarget.value)}
            ...
            <Box sx={{ my: 3 }}>
              ...
              <Label>
                ...
                You take the&nbsp;<Text as="span" style={{ color: 'blue' }}>
                  blue
                </Text>&nbsp;pill: the story ends, you wake up in your bed and believe whatever you want to believe.
              </Label>
              <Label>
                <Radio
            ...
            <Box sx={{ my: 3 }}>
              <Label sx={{ fontStyle: 'italic' }}>
                <Checkbox
                  ...
                  onChange={(event) => onInputChange('acceptTheTruth', !!event.currentTarget.checked)}
