...
<Meta title="UI Components / Forms / Select" component={Select} parameters={{ layout: 'centered' }} />
      ...
      return (
        <React.Fragment>
          ...
          >
            ...
            <option value="embarassing email to company">Send an embarassing email to your entire company</option>
